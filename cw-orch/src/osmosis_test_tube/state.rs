...
pub struct OsmosisTestTubeState {
...
impl Default for OsmosisTestTubeState {
    fn default() -> Self {
        Self::new()
    }
}

impl StateInterface for OsmosisTestTubeState {
    ...
    fn deploy_details(&self) -> DeployDetails {
        let chain_id: String = "osmosis-1".to_string();
...
mod test {
    ...
    #[test]
    fn mock_state() {
        let mut mock = OsmosisTestTubeState::default();
