...
pub fn query_fns_derive(input: ItemEnum) -> TokenStream {
        ...
        match &mut variant.fields {
            ...
            Fields::Named(variant_fields) => {
                ...
                quote!(
                        ...
                        fn #variant_func_name(&self, #(#variant_attr,)*) -> ::core::result::Result<#response, ::cw_orch::CwOrchError> {
    ...
    let derived_trait = quote!(
        pub trait #bname<Chain: ::cw_orch::CwEnv, #type_generics>: ::cw_orch::CwOrcQuery<Chain, QueryMsg = #entrypoint_msg_type #ty_generics #where_clause> {
            #(#variant_fns)*
        }
    );
    ...
    let derived_trait_impl = quote!(
        ...
        where
            SupportedContract: ::cw_orch::CwOrcQuery<Chain, QueryMsg = #entrypoint_msg_type #ty_generics #where_clause>{}
    );
