        ...
        syn::Data::Enum(data) => {
            ...
            quote!(
                ...
                impl ::cw_orch_contract_cli::ParseCwMsg for #name {
                    fn cw_parse(state_interface: &impl ::cw_orch::environment::StateInterface) -> ::cw_orch_contract_cli::OrchCliResult<Self> {
...
fn impl_parse_for_struct(fields: &Fields, name: &proc_macro2::Ident) -> proc_macro2::TokenStream {
    ...
    let derived_trait_impl = quote!(
        #[automatically_derived]
        impl ::cw_orch_contract_cli::ParseCwMsg for #name {
            fn cw_parse(_state_interface: &impl ::cw_orch::environment::StateInterface) -> ::cw_orch_contract_cli::OrchCliResult<Self> {
                Ok(Self {
                    #(#fields),*
                })
            }
