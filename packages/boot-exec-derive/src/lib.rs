            ...
            Fields::Named(variant_fields) => {
                ...
                Some(if variant_idents.is_empty() {
                    quote!(
                        ...
                        fn #variant_func_name(&self, coins: Option<&[::cosmwasm_std::Coin]>) -> Result<::boot_core::TxResponse<Chain>, ::boot_core::BootError> {
                    ...
                    quote!(
                        #[allow(clippy::too_many_arguments)]
                        fn #variant_func_name(&self, #variant_idents, coins: Option<&[::cosmwasm_std::Coin]>) -> Result<::boot_core::TxResponse<Chain>, ::boot_core::BootError> {
                            let msg = #name::#variant_name {
